...
vocab_dir = '/home/phj/NLP/merge/data/vocb.pt'
source = 'train'    # use value: train or  big_samples 
data_path: str = '/home/phj/NLP/merge/data/{}.pt'.format(source)
val_data_path: Optional[str] = '/home/phj/NLP/merge/data/val.pt'
test_data_path: Optional[str] = '/home/phj/NLP/merge/data/test.pt'
max_src_len: int = 650  # exclusive of special tokens such as EOS
